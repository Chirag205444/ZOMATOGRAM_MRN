      ...
      <div className="max-w-screen-md mx-auto">
        ...
        <div className="flex items-center px-4 py-6">
          ...
          <div className="flex-1 flex flex-col justify-center">
             ...
             <p className="text-sm text-gray-400 mt-1 flex items-center gap-1">
                <span className="text-xs">📍</span> Address goes here
             </p>
          </div>
        </div>
        ...
        <div className="flex justify-around text-center py-4 border-t border-b border-zinc-800 mb-6">
           ...
           <div className="flex flex-col items-center">
              ...
              <span className="text-sm text-gray-400 uppercase tracking-wider text-xs font-semibold mt-1">Meals Serve</span>
           </div>
        </div>
